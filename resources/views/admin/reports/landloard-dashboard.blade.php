...
@section('title', 'Landloard Dashboard')
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-cyan hover-expand-effect">
                ...
                <div class="content">
                    <div class="text">PAID RENT</div>
                    <div class="number count-to" data-from="0" data-to="{{ $paid_rent }}" data-speed="1000" data-fresh-interval="20">{{ $paid_rent }}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-light-green hover-expand-effect">
                ...
                <div class="content">
                    ...
                    <div class="number count-to" data-from="0" data-to="{{ $income }}" data-speed="1000" data-fresh-interval="20">{{ $income }}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-orange hover-expand-effect">
                ...
                <div class="content">
                    ...
                    <div class="number count-to" data-from="0" data-to="{{ $expense }}" data-speed="1000" data-fresh-interval="20">{{ $expense }}</div>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-hover dashboard-task-infos">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ ++$key }}.</td>
                                    <td>
                                        <span title="{{ $property->property->title }}">
                                            {{ str_limit($property->property->title, 10) }}
                                        </span>
                                    </td>
                                    <td>{{ $currency }}{{ $property->property->price }}</td>
                                    <td>{{ $property->property->city }}</td>
                                    <td>
                                        @if($property->property->featured == 1)
                                            <span class="label bg-green">F</span>
                                        @endif
                                    </td>
                                    <td>{{ strtok($property->property->status, " ")}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
