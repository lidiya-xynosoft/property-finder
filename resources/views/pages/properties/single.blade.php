                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12 blog-pots">
                                ...
                                <div id="listingDetailsSlider" class="carousel listing-details-sliders slide mb-30">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="active item carousel-item" data-slide-number="0">
                                            <img src="{{ asset('frontend/findhouse/images/single-property/s-1.jpg')}}" class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="1">
                                            <img src="{{ asset('frontend/findhouse/images/single-property/s-2.jpg')}}" class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="2">
                                            <img src="{{ asset('frontend/findhouse/images/single-property/s-3.jpg')}}" class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="4">
                                            <img src="{{ asset('frontend/findhouse/images/single-property/s-4.jpg')}}" class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="5">
                                            <img src="{{ asset('frontend/findhouse/images/single-property/s-5.jpg')}}" class="img-fluid" alt="slider-listing">
                                        </div>
                                    ...
                                    <ul class="carousel-indicators smail-listing list-inline">
                                        <li class="list-inline-item active">
                                            <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#listingDetailsSlider">
                                                <img src="{{ asset('frontend/findhouse/images/single-property/s-1.jpg')}}" class="img-fluid" alt="listing-small">
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a id="carousel-selector-1" data-slide-to="1" data-target="#listingDetailsSlider">
                                                <img src="{{ asset('frontend/findhouse/images/single-property/s-2.jpg')}}" class="img-fluid" alt="listing-small">
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a id="carousel-selector-2" data-slide-to="2" data-target="#listingDetailsSlider">
                                                <img src="{{ asset('frontend/findhouse/images/single-property/s-3.jpg')}}" class="img-fluid" alt="listing-small">
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a id="carousel-selector-3" data-slide-to="3" data-target="#listingDetailsSlider">
                                                <img src="{{ asset('frontend/findhouse/images/single-property/s-4.jpg')}}" class="img-fluid" alt="listing-small">
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a id="carousel-selector-4" data-slide-to="4" data-target="#listingDetailsSlider">
                                                <img src="{{ asset('frontend/findhouse/images/single-property/s-5.jpg')}}" class="img-fluid" alt="listing-small">
                                            </a>
                                        </li>
                                    </ul>
                                    <!-- main slider carousel items -->
                        ...
                        <div class="floor-plan property wprt-image-video w50 pro">
                            <h5>Floor Plans</h5>
                            <img alt="image" src="{{ asset('frontend/findhouse/images/bg/floor-plan-1.png')}}">
                        </div>
                        <div class="floor-plan property wprt-image-video w50 pro">
                            <h5>What's Nearby</h5>
                        ...
                        <section class="reviews comments">
                            ...
                            <div class="row mb-5">
                                <ul class="col-12 commented pl-0">
                                    <li class="comm-inf">
                                        <div class="col-md-2">
                                            <img src="{{ asset('frontend/findhouse/images/testimonials/ts-5.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                        <div class="col-md-10 comments-info">
                                            ...
                                            <div class="rest"><img src="{{ asset('frontend/findhouse/images/single-property/s-1.jpg')}}" class="img-fluid" alt=""></div>
                                        </div>
                                    </li>
                            ...
                            <div class="row">
                                <ul class="col-12 commented pl-0">
                                    <li class="comm-inf">
                                        <div class="col-md-2">
                                            <img src="{{ asset('frontend/findhouse/images/testimonials/ts-4.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                        <div class="col-md-10 comments-info">
                                            <div class="conra">
                            ...
                            <div class="row mt-5">
                                <ul class="col-12 commented mb-0 pl-0">
                                    <li class="comm-inf">
                                        <div class="col-md-2">
                                            <img src="{{ asset('frontend/findhouse/images/testimonials/ts-3.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                        <div class="col-md-10 comments-info">
                                            <div class="conra">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras aliquam, quam congue dictum luctus, lacus magna congue ante, in finibus dui sapien eu dolor. Integer tincidunt suscipit erat, nec laoreet ipsum vestibulum sed.</p>
                                            <div class="resti">
                                                <div class="rest"><img src="{{ asset('frontend/findhouse/images/single-property/s-2.jpg')}}" class="img-fluid" alt=""></div>
                                                <div class="rest"><img src="{{ asset('frontend/findhouse/images/single-property/s-3.jpg')}}" class="img-fluid" alt=""></div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="sidebar">
                                    ...
                                    <div class="widget-boxed-body">
                                        <div class="sidebar-widget author-widget2">
                                            <div class="author-box clearfix">
                                                <img src="{{ asset('frontend/findhouse/images/testimonials/ts-1.jpg')}}" alt="author-image" class="author__img">
                                ...
                                <div class="main-search-field-2">
                                            ...
                                            <div class="recent-post">
                                                <div class="recent-main">
                                                    <div class="recent-img">
                                                        <a href="blog-details.html"><img src="{{ asset('frontend/findhouse/images/feature-properties/fp-1.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="info-img">
                                                ...
                                                <div class="recent-main my-4">
                                                    <div class="recent-img">
                                                        <a href="blog-details.html"><img src="{{ asset('frontend/findhouse/images/feature-properties/fp-2.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="info-img">
                                                        <a href="blog-details.html"><h6>Family Home</h6></a>
                                                        <p>$230,000</p>
                                                ...
                                                <div class="recent-main">
                                                    <div class="recent-img">
                                                        <a href="blog-details.html"><img src="{{ asset('frontend/findhouse/images/feature-properties/fp-3.jpg')}}" alt=""></a>
                                                    </div>
                                                    <div class="info-img">
                                                        <a href="blog-details.html"><h6>Family Home</h6></a>
                                                        <p>$230,000</p>
                                                ...
                                                <div class="agents-grid mr-0">
                                                    <div class="listing-item compact">
                                                        <a href="properties-details.html" class="listing-img-container">
                                                            ...
                                                            <img src="{{ asset('frontend/findhouse/images/feature-properties/fp-1.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="agents-grid mr-0">
                                                    <div class="listing-item compact">
                                                        <a href="properties-details.html" class="listing-img-container">
                                                            ...
                                                            <img src="{{ asset('frontend/findhouse/images/feature-properties/fp-2.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="agents-grid mr-0">
                                                    <div class="listing-item compact">
                                                        <a href="properties-details.html" class="listing-img-container">
                                                            ...
                                                            <img src="{{ asset('frontend/findhouse/images/feature-properties/fp-3.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="agents-grid mr-0">
                                                    <div class="listing-item compact">
                                                        <a href="properties-details.html" class="listing-img-container">
                                                            ...
                                                            <img src="{{ asset('frontend/findhouse/images/feature-properties/fp-4.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="agents-grid mr-0">
                                                    <div class="listing-item compact">
                                                        <a href="properties-details.html" class="listing-img-container">
                                                            ...
                                                            <img src="{{ asset('frontend/findhouse/images/feature-properties/fp-5.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="agents-grid mr-0">
                                                    <div class="listing-item compact">
                                                        <a href="properties-details.html" class="listing-img-container">
                                                            ...
                                                            <img src="{{ asset('frontend/findhouse/images/feature-properties/fp-6.jpg')}}" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="widget-boxed popular mt-5">
                                        ...
                                        <div class="widget-boxed-body">
                                            <div class="banner"><img src="{{ asset('frontend/findhouse/images/single-property/banner.jpg')}}" alt=""></div>
                                        </div>
                                    </div>
                                    <!-- End: Specials offer -->
                                    <div class="widget-boxed popular mt-5">
                                    ...
                                    <div class="project-inner project-head">
                                        <div class="homes">
                                            ...
                                            <a href="single-property-1.html" class="homes-img">
                                                ...
                                                <img src="{{ asset('frontend/findhouse/images/blog/b-11.jpg')}}" alt="home-1" class="img-responsive">
                                            </a>
                                        </div>
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <div class="footer">
                                            <a href="agent-details.html">
                                                <img src="{{ asset('frontend/findhouse/images/testimonials/ts-1.jpg')}}" alt="" class="mr-2"> Lisa Jhonson
                                            </a>
                            ...
                            <div class="item col-lg-4 col-md-6 col-xs-12 people">
                                <div class="project-single">
                                    <div class="project-inner project-head">
                                        <div class="homes">
                                            ...
                                            <a href="single-property-1.html" class="homes-img">
                                                ...
                                                <img src="{{ asset('frontend/findhouse/images/blog/b-12.jpg')}}" alt="home-1" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="button-effect">
                                            <a href="single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <div class="footer">
                                            <a href="agent-details.html">
                                                <img src="{{ asset('frontend/findhouse/images/testimonials/ts-2.jpg')}}" alt="" class="mr-2"> Karl Smith
                                            </a>
                                            <span>2 months ago</span>
                                        </div>
                                    </div>
                            ...
                            <div class="item col-lg-4 col-md-6 col-xs-12 people landscapes no-pb pbp-3">
                                <div class="project-single no-mb mbp-3">
                                    <div class="project-inner project-head">
                                        <div class="homes">
                                            ...
                                            <a href="single-property-1.html" class="homes-img">
                                                <div class="homes-tag button alt sale">For Sale</div>
                                                <div class="homes-price">$9,000/mo</div>
                                                <img src="{{ asset('frontend/findhouse/images/blog/b-1.jpg')}}" alt="home-1" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="button-effect">
                                            <a href="single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <div class="footer">
                                            <a href="agent-details.html">
                                                <img src="{{ asset('frontend/findhouse/images/testimonials/ts-3.jpg')}}" alt="" class="mr-2"> katy Teddy
                                            </a>
                                            <span>2 months ago</span>
                                        </div>
                                    </div>
