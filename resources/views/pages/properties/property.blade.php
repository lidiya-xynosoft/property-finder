                    ...
                    <div class="detail-wrapper-body">
                        <div class="listing-title-bar">
                            <div class="text-heading text-left">
                                <p class="pb-2"><a href="{{ route('home') }}">Home </a> &nbsp;/&nbsp;
                                    <span>Listings</span>
                                </p>
                            </div>
                            <h3>List View</h3>
                        ...
                        <div class="pro-wrapper">
                            ...
                            <div
                                ...
                                <div class="sorting-options">
                                    ...
                                    <a href="properties-grid-1.html" class="change-view-btn lde"><i
                    ...
                    <div class="row featured portfolio-items">
                        ...
                        <div class="footer">
                            ...
                            <a href="agent-details.html">
                                @if (Storage::disk('public')->exists('property/' . $property->user->image) && $property->user->image)
                                    <img src="{{ Storage::url('property/' . $property->user->image) }}"
                                        alt="{{ $property->title }}" class="mr-2">
                                @endif
                                {{ $property->user->name }}
                            </a>
